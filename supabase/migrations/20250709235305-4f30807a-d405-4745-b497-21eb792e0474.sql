...
DROP POLICY IF EXISTS "Admins can update any user profile" ON public.profiles CASCADE;
DROP POLICY IF EXISTS "Admins can view all profiles" ON public.profiles CASCADE;
DROP POLICY IF EXISTS "Admins can update any profile" ON public.profiles CASCADE;
DROP POLICY IF EXISTS "Admins can create profiles" ON public.profiles CASCADE;
