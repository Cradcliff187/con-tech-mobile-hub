...
import { useRFIDocuments } from '@/hooks/useRFIs';
...
interface RFIDocumentsProps {
  rfiId: string;
  projectId: string;
  readOnly?: boolean;
}

export const RFIDocuments = ({ rfiId, projectId, readOnly = false }: RFIDocumentsProps) => {
  const { documents, loading, attachDocument, detachDocument } = useRFIDocuments(rfiId);
      ...
      <CardContent className="space-y-4">
        ...
        {documents.length === 0 ? (
          <div className="text-center py-6 text-slate-500">
            ...
            <p>No documents attached to this RFI</p>
            {!readOnly && (
